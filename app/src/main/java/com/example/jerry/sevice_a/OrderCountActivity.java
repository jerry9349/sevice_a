...
public class OrderCountActivity extends Fragment{

    //TabPagerAdapter에서 연결된 총 주문 목록 페이지

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_order_count,container,false);
